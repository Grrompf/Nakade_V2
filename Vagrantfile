...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "nakade"
  #config.vm.post_up_message ="use vagrant ssh for sign in"
  ...
  # configure bindfs plugin to enforce permissions that satisfy webserver and developer as well
